 ...
 * @param {string} arg2.text - text to be displayed (default: "Map title")
 ...
 * @param {number} arg2.margin - margin (default: 8)
 * @param {number} arg2.fontSize - text font-size (default: 26)
