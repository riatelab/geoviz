...
import { typo_vertical } from "../legend/typo-vertical.js";
import { typo_horizontal } from "../legend/typo-horizontal.js";
import { implantation, unique } from "../helpers/utils.js";
 ...
 * @example // Usage
 * geoviz.plot({type:"proptypo", data: world, var1: "pop", var2: "regions"})
 * geoviz.proptypo({ data: world, var1: "pop", var2: "gdppc"})
 */

export async function proptypo(arg1, arg2) {
  let newcontainer =
